    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.success) {
                console.log(response)
                if (response.data.length == 0) {
                    swal(_getDialogOption2('กรุณาเพิ่มคลังและที่เก็บในระบบ SML')).then(function () {
                        $("#content-database-list").empty();
                        $("#content-authentication-box").fadeIn("fast");
                        $("#content-database-box").fadeOut("fast");
                        $("#txt_provider_code").focus();
        ...
        success: function (response) {
            ...
            if (response.success) {
                if (response.data.length > 0) {
                    ...
                    swal(_getDialogOption('กรุณาเพิ่มคลังและที่เก็บในระบบ SML')).then(function () {
                        $("#content-database-list").empty();
                        $("#content-authentication-box").fadeIn("fast");
                        $("#content-database-box").fadeOut("fast");
                        $("#txt_provider_code").focus();
...
function _getDialogOption2(strMessage) {
    return {
