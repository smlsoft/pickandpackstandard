...
@WebServlet(name = "warehouse-print-2", urlPatterns = {"/warehouse-print-2"})
public class Print2 extends HttpServlet {
    ...
    private JSONObject _printData(Connection conn, JSONObject param) throws SQLException, Exception {
        ...
        while (__rsData1.next()) {
            ...
            while (__rsDataRemark.next()) {
                ...
                __strQUERY = "SELECT * FROM (SELECT ic_code,qty ,event_qty ,wh_code,unit_code,line_number,COALESCE(lot_number_1,'') as lot_number_1, "
                ...
                if (__rowCount <= 13) {
                    ...
                    while (__rsData4.next()) {
                        ...
                        __rsHTML += "<td>" + (__rsData4.getString("lot_number_1")) + "</td>";
                        __rsHTML += "</tr>";
                    }
    ...
    private JSONObject printData(Connection conn, JSONObject param) throws SQLException, Exception {
        ...
        while (__rsData.next()) {
            ...
            while (__rsDataRemark.next()) {
                ...
                __objData.put("user_print", __rsData.getString("user_print"));
    ...
    private String renderPrintBody(Connection __conn, ResultSet __rsDataHead, JSONObject objData) throws Exception {
        ...
        __strQuery = "SELECT * FROM (SELECT ic_code,qty ,event_qty ,wh_code,unit_code,line_number,COALESCE(lot_number_1,'') as lot_number_1, "
                + " (SELECT name_1 from ic_inventory WHERE ic_inventory.code = pp_trans_detail.ic_code) AS item_name,"
                + " COALESCE((select barcode from ic_inventory_barcode where ic_code=pp_trans_detail.ic_code and unit_code = pp_trans_detail.unit_code limit 1), '') AS barcode,"
                + " COALESCE((select sign_code from ic_inventory where code=pp_trans_detail.ic_code), '') AS sign_code,"
                + " (SELECT item_type from ic_inventory WHERE ic_inventory.code = pp_trans_detail.ic_code) AS item_type, "
                + " (SELECT name_1 from ic_warehouse WHERE ic_warehouse.code = pp_trans_detail.wh_code) AS wh_name ,shelf_code, "
                + " (SELECT name_1 from ic_shelf WHERE ic_shelf.code = pp_trans_detail.shelf_code and ic_shelf.whcode= pp_trans_detail.wh_code) AS shelf_name, "
                + " (SELECT name_1 from ic_unit WHERE ic_unit.code = pp_trans_detail.unit_code)AS unit_name from pp_trans_detail "
        ...
        int __divideValue = 10;
        int __itemShowValue = 10;
        ...
        for (int loop = 0; loop < totalCount1; loop++) {
            ...
            __strHTML += "      <thead style='font-size: 14px;'>"
                    ...
                    + "                 <td><strong>บาร์โค้ด</strong></td>"
                    + "                 <td><strong>รูป</strong></td>"
                    ...
                    + "                 <td><strong>เครื่องหมาย</strong></td>"
                    + "             </tr>";
            __strHTML += "      </thead>";
            __strHTML += "      <tbody style='font-size: 14px;'>";
            ...
            while (__rsData.next()) {
                ...
                String __strWhCode = __rsData.getString("wh_name") != null ? !__rsData.getString("wh_name").isEmpty() ? __rsData.getString("wh_name") : "" : "";
                String __strShelfCodeX = __rsData.getString("shelf_name") != null ? !__rsData.getString("shelf_name").isEmpty() ? __rsData.getString("shelf_name") : "" : "";
                ...
                __stmtHeader = __conn_pic.prepareStatement(query);
                ...
                if (!contourChart.equals("")) {
                    __strHTML += "          <td><img src='" + contourChart + "' style='width:30px;height:28px'></td>";
                } else {
                    __strHTML += "          <td></td>";
                }
    ...
    private String renderPrintFooter(JSONObject objData) throws Exception {
        ...
        __strHTML += "  <div class='row' style='font-size: 14px;'>";
        ...
        __strHTML += "              <div class='col-lg-4 col-md-4 col-sm-4 col-xs-4'>";
        __strHTML += "                  <p>" + objData.getString("user_pack") + "</p>";
        __strHTML += "              </div>";
        __strHTML += "              <div class='col-lg-4 col-md-4 col-sm-4 col-xs-4'>";
        __strHTML += "                  <p>........................................</p>";
        __strHTML += "              </div>";
        ...
        __strHTML += "  </div>";
        __strHTML += "  <div class='row text-right'>";
        __strHTML += "      <p><strong>ผู้พิมพ์:</strong>   " + objData.getString("user_print") + "   วันที่:    " + newDate + "<p>";
        __strHTML += "  </div>";
        __strHTML += "</div>";
        return __strHTML;
    }
