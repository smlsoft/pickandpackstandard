    ...
    private String renderPrintBody(Connection __conn, ResultSet __rsDataHead, JSONObject objData) throws Exception {
        ...
        for (int loop = 0; loop < totalCount1; loop++) {
            ...
            while (__rsData.next()) {
                ...
                String __lot_number_1 = __rsData.getString("lot_number_1") != null ? !__rsData.getString("lot_number_1").isEmpty() ? __rsData.getString("lot_number_1") : "" : "";
                __strHTML += "      <tr>";
                ...
                __strHTML += "          <td>" + __lot_number_1 + "</td>";
