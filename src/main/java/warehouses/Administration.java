...
public class Administration extends HttpServlet {
    ...
    private JSONObject _getMainDetail(Connection conn, JSONObject param) throws SQLException, Exception {
        ...
        System.out.println("__strQueryPagination " + __strQUERY);
        ...
        while (__rsData1.next()) {
            ...
            if (__rsData1.getString("last_status").equals("1")) {
                __rsHTML += "<tr class='" + __strRefCode + "' car_code='" + __rsData1.getString("car_code") + "'  style='background-color: #FF6666; color:#FFF' key_id='" + __strRefCode + "'>";
            } else {
                __rsHTML += "<tr class='" + __strRefCode + "' car_code='" + __rsData1.getString("car_code") + "' >";
            }
            ...
            if (__strLastStatus.equals("1")) {
                ...
                __strQUERY = "SELECT array_to_string(array(SELECT DISTINCT status FROM pp_trans WHERE ref_code='" + __strRefCode + "'" + " AND is_close=0 ORDER BY status DESC), ',') AS status";
            ...
            __rsHTML += "<td><button type='button' id='btn-more' class='btn btn-info btn-flat' key_id='" + __strRefCode + "' car_code='" + __strCarCode + "' shipment_code=''>เพิ่มเติม</button></td>";

            if (__isPrint == 0) {
                __rsHTML += "<td><button type='button' id='btn-print' class='btn btn-success btn-flat is_print' key_id='" + __strRefCode + "' car_code='" + __strCarCode + "' shipment_code='' is_print='" + __isPrint + "' trans_flag='" + __rsData1.getString("trans_flag") + "'>พิมพ์</button></td>";
            } else {
                __rsHTML += "<td><button type='button' id='btn-print' class='btn btn-success btn-flat is_print' disabled key_id='" + __strRefCode + "' car_code='" + __strCarCode + "' shipment_code='' is_print='" + __isPrint + "' trans_flag='" + __rsData1.getString("trans_flag") + "'>พิมพ์</button></td>";
            }
            __rsHTML += "<td><button type='button' id='btn-delete' class='btn btn-danger btn-flat' key_id='" + __strRefCode + "'>ลบ</button></td>";
            __rsHTML += "</tr>";
            __rsHTML += "<tr id='" + __strRefCode + "_" + __strCarCode + "_' style='display: none;'></tr>";
        }
